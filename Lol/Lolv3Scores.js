...
class Lolv3ScoresClient extends BaseClient {
    constructor(apiKey){
        super(apiKey);
    }
    ...
    getAreasCountriesPromise(){
        return this.GetPromise('/v3/lol/scores/{format}/Areas');
    }
    ...
    getCompetitionFixturesLeagueDetailsPromise(competitionid){
        ...
        return this.GetPromise('/v3/lol/scores/{format}/CompetitionDetails/{competitionid}', parameters);
    }
    ...
    getCompetitionsLeaguesPromise(){
        return this.GetPromise('/v3/lol/scores/{format}/Competitions');
    }
    ...
    getGamesByDatePromise(date){
        ...
        return this.GetPromise('/v3/lol/scores/{format}/GamesByDate/{date}', parameters);
    }
    ...
    getMembershipsActivePromise(){
        return this.GetPromise('/v3/lol/scores/{format}/ActiveMemberships');
    }
    ...
    getMembershipsHistoricalPromise(){
        return this.GetPromise('/v3/lol/scores/{format}/HistoricalMemberships');
    }
    ...
    getMembershipsByTeamActivePromise(teamid){
        ...
        return this.GetPromise('/v3/lol/scores/{format}/MembershipsByTeam/{teamid}', parameters);
    }
    ...
    getMembershipsByTeamHistoricalPromise(teamid){
        var parameters = {};
        parameters['teamid']=teamid;
        return this.GetPromise('/v3/lol/scores/{format}/HistoricalMembershipsByTeam/{teamid}', parameters);
    }
    ...
    getPlayerPromise(playerid){
        ...
        return this.GetPromise('/v3/lol/scores/{format}/Player/{playerid}', parameters);
    }
    ...
    /// </summary>
    getPlayersPromise(){
        return this.GetPromise('/v3/lol/scores/{format}/Players');
    }
    ...
    getPlayersByTeamPromise(teamid){
        var parameters = {};
        parameters['teamid']=teamid;
        return this.GetPromise('/v3/lol/scores/{format}/PlayersByTeam/{teamid}', parameters);
    }
    ...
    getSchedulePromise(roundid){
        ...
        return this.GetPromise('/v3/lol/scores/{format}/Schedule/{roundid}', parameters);
    }
    ...
    getSeasonTeamsPromise(seasonid){
        ...
        return this.GetPromise('/v3/lol/scores/{format}/SeasonTeams/{seasonid}', parameters);
    }
    ...
    getStandingsPromise(roundid){
        var parameters = {};
        parameters['roundid']=roundid;
        return this.GetPromise('/v3/lol/scores/{format}/Standings/{roundid}', parameters);
    }
    ...
    /// </summary>
    getTeamsPromise(){
        return this.GetPromise('/v3/lol/scores/{format}/Teams');
    }
    ...
    /// </summary>
    getVenuesPromise(){
        return this.GetPromise('/v3/lol/scores/{format}/Venues');
    }

}

module.exports = Lolv3ScoresClient;
