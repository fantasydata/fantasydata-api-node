...
class MMAv3ScoresClient extends BaseClient {
    constructor(apiKey){
        super(apiKey);
    }
    ...
    getEventPromise(eventid){
        ...
        return this.GetPromise('/v3/mma/scores/{format}/Event/{eventid}', parameters);
    }
    ...
    /// </summary>
    getLeaguesPromise(){
        return this.GetPromise('/v3/mma/scores/{format}/Leagues');
    }
...
module.exports = MMAv3ScoresClient;
