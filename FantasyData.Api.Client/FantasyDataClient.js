...
const FantasyDataNFLFantasyAPIClient = require('./NFLv3/FantasyDataNFLFantasyAPI');
const FantasyDataNFLOddsAPIClient = require('./NFLv3/FantasyDataNFLOddsAPI');
...
const NFLv3AntelopePredictionsClient = require('./NFLv3/NFLv3AntelopePredictions');
...
const FantasyDataMLBFantasyAPIClient = require('./MLB/FantasyDataMLBFantasyAPI');
const FantasyDataMLBOddsAPIClient = require('./MLB/FantasyDataMLBOddsAPI');
...
const FantasyDataNBAFantasyAPIClient = require('./NBA/FantasyDataNBAFantasyAPI');
const FantasyDataNBAOddsAPIClient = require('./NBA/FantasyDataNBAOddsAPI');
...
const FantasyDataNHLFantasyAPIClient = require('./NHL/FantasyDataNHLFantasyAPI');
const FantasyDataNHLOddsAPIClient = require('./NHL/FantasyDataNHLOddsAPI');
...
const FantasyDataCFBFantasyAPIClient = require('./CFB/FantasyDataCFBFantasyAPI');
const FantasyDataCFBOddsAPIClient = require('./CFB/FantasyDataCFBOddsAPI');
...
const FantasyDataCBBFantasyAPIClient = require('./CBB/FantasyDataCBBFantasyAPI');
const FantasyDataCBBOddsAPIClient = require('./CBB/FantasyDataCBBOddsAPI');
const Golfv2Client = require('./Golf/Golfv2');
const FantasyDataGolfAPIClient = require('./Golf/FantasyDataGolfAPI');
const Golfv3HeadshotsClient = require('./Golf/Golfv3Headshots');
const NASCARv2Client = require('./Nascar/NASCARv2');
const FantasyDataNASCARAPIClient = require('./Nascar/FantasyDataNASCARAPI');
...
const Lolv1ProjectionsClient = require('./Lol/Lolv1Projections');
...
class FantasyDataClient {
    constructor(apiKeys){
        ...
        this.FantasyDataNFLFantasyAPIClient = new FantasyDataNFLFantasyAPIClient(apiKeys.FantasyDataNFLFantasyAPIClient);
        this.FantasyDataNFLOddsAPIClient = new FantasyDataNFLOddsAPIClient(apiKeys.FantasyDataNFLOddsAPIClient);
        ...
        this.NFLv3AntelopePredictionsClient = new NFLv3AntelopePredictionsClient(apiKeys.NFLv3AntelopePredictionsClient);
        ...
        this.FantasyDataMLBFantasyAPIClient = new FantasyDataMLBFantasyAPIClient(apiKeys.FantasyDataMLBFantasyAPIClient);
        this.FantasyDataMLBOddsAPIClient = new FantasyDataMLBOddsAPIClient(apiKeys.FantasyDataMLBOddsAPIClient);
        ...
        this.FantasyDataNBAFantasyAPIClient = new FantasyDataNBAFantasyAPIClient(apiKeys.FantasyDataNBAFantasyAPIClient);
        this.FantasyDataNBAOddsAPIClient = new FantasyDataNBAOddsAPIClient(apiKeys.FantasyDataNBAOddsAPIClient);
        ...
        this.FantasyDataNHLFantasyAPIClient = new FantasyDataNHLFantasyAPIClient(apiKeys.FantasyDataNHLFantasyAPIClient);
        this.FantasyDataNHLOddsAPIClient = new FantasyDataNHLOddsAPIClient(apiKeys.FantasyDataNHLOddsAPIClient);
        ...
        this.FantasyDataCFBFantasyAPIClient = new FantasyDataCFBFantasyAPIClient(apiKeys.FantasyDataCFBFantasyAPIClient);
        this.FantasyDataCFBOddsAPIClient = new FantasyDataCFBOddsAPIClient(apiKeys.FantasyDataCFBOddsAPIClient);
        ...
        this.FantasyDataCBBFantasyAPIClient = new FantasyDataCBBFantasyAPIClient(apiKeys.FantasyDataCBBFantasyAPIClient);
        this.FantasyDataCBBOddsAPIClient = new FantasyDataCBBOddsAPIClient(apiKeys.FantasyDataCBBOddsAPIClient);
        this.Golfv2Client = new Golfv2Client(apiKeys.Golfv2Client);
        this.FantasyDataGolfAPIClient = new FantasyDataGolfAPIClient(apiKeys.FantasyDataGolfAPIClient);
        ...
        this.FantasyDataNASCARAPIClient = new FantasyDataNASCARAPIClient(apiKeys.FantasyDataNASCARAPIClient);
        ...
        this.Lolv1ProjectionsClient = new Lolv1ProjectionsClient(apiKeys.Lolv1ProjectionsClient);
