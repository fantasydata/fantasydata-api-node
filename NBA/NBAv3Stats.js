...
class NBAv3StatsClient extends BaseClient {
    ...
    getPlayerGameStatsByDateFinalPromise(date){
        var parameters = {};
        parameters['date']=date;
        return this.GetPromise('/v3/nba/stats/{format}/PlayerGameStatsByDateFinal/{date}', parameters);
    }
    ...
    getTeamGameStatsByDateFinalPromise(date){
        var parameters = {};
        parameters['date']=date;
        return this.GetPromise('/v3/nba/stats/{format}/TeamGameStatsByDateFinal/{date}', parameters);
    }
    ...
    getBoxScoreFinalPromise(gameid){
        var parameters = {};
        parameters['gameid']=gameid;
        return this.GetPromise('/v3/nba/stats/{format}/BoxScoreFinal/{gameid}', parameters);
    }
    ...
    getBoxScoresByDateFinalPromise(date){
        var parameters = {};
        parameters['date']=date;
        return this.GetPromise('/v3/nba/stats/{format}/BoxScoresFinal/{date}', parameters);
    }
    ...
    getFantasyPointsByDatePromise(date){
        var parameters = {};
        parameters['date']=date;
        return this.GetPromise('/v3/nba/stats/{format}/FantasyGameStatsByDate/{date}', parameters);
    }
