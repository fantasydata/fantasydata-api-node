...
class NBAv3OddsClient extends BaseClient {
    ...
    getBettingFuturesBySeasonSportsbookGroupPromise(season, sportsbookgroup){
        ...
        return this.GetPromise('/v3/nba/odds/{format}/BettingFuturesBySeason/{season}/{sportsbookgroup}', parameters);
    }
    ...
    getBettingMarketSportsbookGroupPromise(marketId, sportsbookgroup){
        ...
        parameters['marketId']=marketId;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/BettingMarket/{marketId}/{sportsbookgroup}', parameters);
    }
    ...
    getBettingMarketsByEventSportsbookGroupPromise(eventId, sportsbookgroup, include){
        ...
        parameters['sportsbookgroup']=sportsbookgroup;
        parameters['include']=include;
        return this.GetPromise('/v3/nba/odds/{format}/BettingMarketsByEvent/{eventId}/{sportsbookgroup}', parameters);
    }
    ...
    getBettingMarketsByGameSportsbookGroupPromise(gameID, sportsbookgroup, include){
        ...
        parameters['sportsbookgroup']=sportsbookgroup;
        parameters['include']=include;
        return this.GetPromise('/v3/nba/odds/{format}/BettingMarketsByGameID/{gameID}/{sportsbookgroup}', parameters);
    }
    ...
    getBettingMarketsByMarketTypeSportsbookGroupPromise(eventId, marketTypeID, sportsbookgroup, include){
        ...
        parameters['sportsbookgroup']=sportsbookgroup;
        parameters['include']=include;
        return this.GetPromise('/v3/nba/odds/{format}/BettingMarketsByMarketType/{eventId}/{marketTypeID}/{sportsbookgroup}', parameters);
    }
    ...
    getBettingPlayerPropsByGameSportsbookGroupPromise(gameId, sportsbookgroup, include){
        ...
        parameters['sportsbookgroup']=sportsbookgroup;
        parameters['include']=include;
        return this.GetPromise('/v3/nba/odds/{format}/BettingPlayerPropsByGameID/{gameId}/{sportsbookgroup}', parameters);
    }
    ...
    getBettingResultsByMarketSportsbookGroupPromise(marketId, sportsbookgroup){
        ...
        parameters['marketId']=marketId;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/BettingResultsByMarket/{marketId}/{sportsbookgroup}', parameters);
    }
    ...
    getInGameOddsByDateSportsbookGroupPromise(date, sportsbookgroup){
        ...
        parameters['date']=date;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/InGameOddsByDate/{date}/{sportsbookgroup}', parameters);
    }
    ...
    getInGameOddsLineMovementSportsbookGroupPromise(gameid, sportsbookgroup){
        ...
        parameters['gameid']=gameid;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/InGameLineMovement/{gameid}/{sportsbookgroup}', parameters);
    }
    ...
    getPreGameAndPeriodGameOddsByDateSportsbookGroupPromise(date, sportsbookgroup){
        ...
        parameters['date']=date;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/PreGameOddsByDate/{date}/{sportsbookgroup}', parameters);
    }
    ...
    getPreGameAndPeriodGameOddsLineMovementSportsbookGroupPromise(gameid, sportsbookgroup){
        ...
        parameters['gameid']=gameid;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/PreGameOddsLineMovement/{gameid}/{sportsbookgroup}', parameters);
    }
    ...
    getInGameOddsLineMovementWithResultingSportsbookGroupPromise(gameid, sportsbookgroup){
        ...
        parameters['gameid']=gameid;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/InGameLineMovementWithResulting/{gameid}/{sportsbookgroup}', parameters);
    }
    ...
    getPreGameAndPeriodGameOddsLineMovementWithResultingSportsbookGroupPromise(gameid, sportsbookgroup){
        ...
        parameters['gameid']=gameid;
        parameters['sportsbookgroup']=sportsbookgroup;
        return this.GetPromise('/v3/nba/odds/{format}/PreGameOddsLineMovementWithResulting/{gameid}/{sportsbookgroup}', parameters);
    }
